        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-neutral-400 dark:text-neutral-500 mb-6 leading-relaxed max-w-sm">
              Making mental health support accessible, secure, and effective for all university students.
            </p>
            <div className="flex gap-4">
              <a
                href="https://twitter.com/mentwel"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-neutral-800 dark:bg-neutral-700 rounded-full flex items-center justify-center text-neutral-400 dark:text-neutral-500 hover:bg-sky-500 hover:text-white transition-all"
                aria-label="Twitter"
              >
                <Twitter className="w-5 h-5" />
              </a>
              <a
                href="https://facebook.com/mentwel"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-neutral-800 dark:bg-neutral-700 rounded-full flex items-center justify-center text-neutral-400 dark:text-neutral-500 hover:bg-sky-500 hover:text-white transition-all"
                aria-label="Facebook"
              ...
              <a
                href="https://instagram.com/mentwel"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-neutral-800 dark:bg-neutral-700 rounded-full flex items-center justify-center text-neutral-400 dark:text-neutral-500 hover:bg-sky-500 hover:text-white transition-all"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.path}>
                  <Link to={link.path} className="text-neutral-400 dark:text-neutral-500 hover:text-sky-500 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
